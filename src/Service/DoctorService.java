...
public class DoctorService{
	...
	public boolean add(DoctorModel patient){
		
		if(patient.getId().equals("") || patient.getName().equals("") || patient.getGender().equals("") || patient.getAge().equals("") || patient.getPhoneNo().equals("") || patient.getAddress().equals("")|| patient.getDisease().equals("")|| patient.getPrescription().equals("")){
		...
		String sql=" ";
		sql+="INSERT INTO "; 
        sql+="PATIENTS(ID, NAME, GENDER, AGE, PHONE, ADDRESS, DISEASE, ADMISSIONDATE, CABINNO,PRESCRIPTION)";
        sql+="values('"+patient.getId()+"','"+patient.getName()+"','"+patient.getGender()+"','"+patient.getAge()+"','"+patient.getPhoneNo()+"','"+patient.getAddress()+"','"+patient.getDisease()+"','"+patient.getAdmissionDate()+"','"+patient.getCabinNo()+"','"+patient.getPrescription()+"')";
	...
	public List<DoctorModel>  getAll(){
		...
		try{
			String sql2 ="";
			sql2 = "select ID, NAME, GENDER, AGE, PHONE, ADDRESS, DISEASE, ADMISSIONDATE, CABINNO,PRESCRIPTION from PATIENTS";
            ...
            while(rs.next()){
				DoctorModel patient = new DoctorModel();
	...
	public boolean update(String id,String name,String gender,String age,String phone,String address,String disease, String admissionDate, String cabinNo,String prescription){
			
             try{
              
                String sql = "update PATIENTS set NAME = '"+name+"', Gender='"+gender+"', AGE='"+age+"', PHONE='"+phone+"', ADDRESS='"+address+"',DISEASE ='"+disease+"',ADMISSIONDATE='"+admissionDate+"',CABINNO='"+cabinNo+"',PRESCRIPTION='"+prescription+"' where ID = '"+id+"'";
