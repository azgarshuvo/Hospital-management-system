...
public void start(Stage stage){
	...
	addButton.setOnAction(e->{
		...
		PatientModel patientModel = new PatientModel(id, name, gender, age, phoneNo, address, disease, admissionDate, cabinNo);
		PatientService patientService = new PatientService();
		patientService.add(patientModel);
	...
	HBox h10=new HBox(10,addButton,menuButton);
